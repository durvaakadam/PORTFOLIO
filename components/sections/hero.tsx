...
<div className="flex justify-start mt-4 gap-4">
  ...
  <a href="mailto:durvakadam204@gmail.com" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-accent hover:scale-125 transition-all duration-300">
    ...
    <span className="sr-only">Email</span>
        ...
        {/* RIGHT — TAGLINE + LOCATION */}
        <div className="flex flex-col justify-center text-left max-w-xl lg:max-w-2xl relative pl-10 py-4 lg:py-8">

          {/* Vertical accent */}
          <div className="absolute left-0 top-1/2 -translate-y-1/2 h-56 lg:h-72 w-[4px] bg-accent rounded-full" />
